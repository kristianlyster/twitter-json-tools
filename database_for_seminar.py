...
db = peewee.SqliteDatabase('tweets_test.db', threadlocals=True)
db.connect()
...
class Tweet(BaseModel):
    ...
    language = peewee.ForeignKeyField(Language, null=True) #Null = true means that the database can accept no reply.
